...
const LogoSmall = ({ className }: SVGProps<SVGSVGElement>) => {
  const paint0Linear11273 = useId()
  return (
    <svg
      width='30'
      height='30'
    ...
    >
      <path
        ...
        fill={`url(#${paint0Linear11273})`}
      />
      <defs>
        <linearGradient
          id={paint0Linear11273}
          x1='5'
          y1='50'
          x2='65'
          y2='50'
        ...
        >
          ...
          <stop offset='0.461458' stopColor='#3121FF' />
        </linearGradient>
      </defs>
    </svg>
  )
