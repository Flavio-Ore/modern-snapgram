...
const PeopleIcon = ({ className }: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    />
    <path d='M15 2.25a.75.75 0 0 0 0 1.5 2.25 2.25 0 0 1 0 4.5.75.75 0 0 0 0 1.5 3.75 3.75 0 1 0 0-7.5' />
    <path
      fillRule='evenodd'
      clipRule='evenodd'
    ...
    />
    <path d='M18.16 13.267a.75.75 0 0 0-.32 1.466c.792.173 1.425.472 1.843.814s.567.677.567.953c0 .25-.12.545-.453.854-.335.311-.85.598-1.513.798a.75.75 0 1 0 .432 1.437c.823-.248 1.558-.631 2.102-1.136.546-.507.932-1.174.932-1.953 0-.865-.474-1.588-1.117-2.114-.644-.527-1.51-.908-2.472-1.119' />
  </svg>
)
